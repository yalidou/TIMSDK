...
- (void)setupViews {
    ...
    [_faceButton setImage:[UIImage imageNamed:@"单聊-表情"] forState:UIControlStateNormal];
    [_faceButton setImage:[UIImage imageNamed:@"单聊-表情"] forState:UIControlStateHighlighted];
...
//    [_faceButton setImage:TUIChatBundleThemeImage(@"chat_ToolViewEmotionHL_img", @"ToolViewEmotionHL") forState:UIControlStateHighlighted];
    ...
    //TUIChatDynamicColor(@"chat_input_bg_color", @"#FFFFFF");
    ...
    _inputTextView.contentInset = UIEdgeInsetsMake(0, 5, 0, 5);
    [self addSubview:_inputTextView];
    
    _placeHold = [[UILabel alloc]init];
    _placeHold.backgroundColor = [UIColor colorWithRed:248/255.0 green:248/255.0 blue:248/255.0 alpha:1];
    _placeHold.textColor = [UIColor colorWithRed:136/255.0 green:136/255.0 blue:136/255.0 alpha:1];
    _placeHold.font = [UIFont systemFontOfSize:13];
    _placeHold.text = @"请输入文字";
    [_inputTextView addSubview:_placeHold];
...
- (void)applyBorderTheme {
    ...
    if (_inputTextView) {
        ...
        [_inputTextView.layer setCornerRadius:20.0f];
...
- (void)defaultLayout {
    ...
    [_placeHold mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_inputTextView.mas_left).mas_offset(10);
        make.width.mas_equalTo(100);
        make.centerY.mas_equalTo(_inputTextView);
    }];
}
