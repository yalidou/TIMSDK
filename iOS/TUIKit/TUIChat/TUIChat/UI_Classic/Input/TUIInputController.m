...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [_inputBar.delegate inputBarDidTouchMore:_inputBar];
}
...
- (void)setupViews {
    ...
    //TUIChatDynamicColor(@"chat_input_controller_bg_color", @"#EBF0F6");
...
- (void)showMoreAnimation {
    ...
    if ([self.view.subviews containsObject:self.moreView]) {
        return;
    }
